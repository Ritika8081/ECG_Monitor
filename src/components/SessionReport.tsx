                    ...
                    <div className="mb-2">
                        ...
                        <div className="grid grid-cols-4 gap-4 items-stretch">
                            ...
                            <div className="flex flex-col h-full col-span-2">
                                <div className={`p-2 rounded-lg border flex flex-col gap-2 flex-1 ${analysisResults.aiClassification.prediction === "Normal"
                                                ...
                                                <ul className="space-y-1">
                                                    {analysisResults.abnormalities.map((abnormality, index) => (
                                                        <li key={index} className="flex items-start gap-2">
                                                            <span className={`w-2 h-2 rounded-full mt-1 ${abnormality.severity === 'high' ? 'bg-red-500' :
                                                                abnormality.severity === 'medium' ? 'bg-yellow-500' : 'bg-blue-500'
                                                                }`}></span>
                                                            <div>
                                                                <div className={`font-medium text-xs ${abnormality.severity === 'high' ? 'text-red-400' :
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-5 gap-3">
                                ...
                                <div className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-3">
                                    ...
                                    <div className={`font-bold text-lg ${analysisResults.intervals.qtc.status === 'normal' ? 'text-green-400' : 'text-red-400'
                                        }`}>
                                ...
                                <div className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-3">
                                    ...
                                    <div className={`font-bold text-lg ${analysisResults.intervals.st.status === 'normal' ? 'text-green-400' :
